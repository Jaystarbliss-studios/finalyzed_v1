-- Ensure the writer project participant RPC exists in the production schema.
-- The dashboard calls this RPC first so writers can see projects through both
-- projects.writer_id and project_assignments.writer_id.
