export default async (req: Request) => {
  ...
  return new Response(JSON.stringify({source:'National Universities Commission',count:unique.length,institutions:unique}), {headers:{'content-type':'application/json','cache-control':'public,max-age=86400'}});
};
